...
# if (!$?) { exit 1 }
 ...
 ../OGM-Common/scripts/setup/reusable/Build-Step.ps1 release_REG1_LAN_TP_BASE firmware-Sonos-REG1-LAN-TP-Base esp32
 if (!$?) { exit 1 }

 ../OGM-Common/scripts/setup/reusable/Build-Step.ps1 release_REG1_LAN_IP_BASE firmware-Sonos-REG1-LAN-IP-Base esp32
 if (!$?) { exit 1 }

 ../OGM-Common/scripts/setup/reusable/Build-Step.ps1 release_Adafruit_Feather_ESP32_V2_TP firmware-Sonos-Adafruit_Feather_ESP32_V2_TP esp32
 if (!$?) { exit 1 }

 ../OGM-Common/scripts/setup/reusable/Build-Step.ps1 release_Adafruit_Feather_ESP32_V2_IP firmware-Sonos-Adafruit_Feather_ESP32_V2_IP esp32
 if (!$?) { exit 1 }
