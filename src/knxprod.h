...
#define MAIN_ParameterSize 2051
...
#define LOG_BuzzerSilent                        323      // uint16_t
#define LOG_BuzzerNormal                        325      // uint16_t
#define LOG_BuzzerLoud                          327      // uint16_t
#define LOG_VisibleChannels                     329      // uint8_t
#define LOG_LedMapping                          330      // 3 Bits, Bit 7-5
...
// Parameter per channel
#define LOG_ParamBlockOffset 331
...
#define BASE_KommentarModuleParamOffset 2051
